...
recipes.addShaped(<StevesCarts:upgrade:1>, [[<Creator:enderDiamond>, <ore:dustGlowstone>, <Creator:enderDiamond>], [<ore:dustGlowstone>, <ore:gemEmerald>, <ore:dustGlowstone>], [<Creator:enderDiamond>, <StevesCarts:upgrade>, <Creator:enderDiamond>]]);
