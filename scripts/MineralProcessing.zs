...
mods.thermalexpansion.Furnace.removeRecipe(<Magneticraft:item.chunks:7>);
mods.thermalexpansion.Furnace.removeRecipe(<Magneticraft:item.rubble:7>);
mods.thermalexpansion.Furnace.removeRecipe(<Magneticraft:item.pebbles:7>);
mods.thermalexpansion.Furnace.removeRecipe(<Magneticraft:item.dust:7>);
...
mods.thermalexpansion.Smelter.removeRecipe(<*>, <Magneticraft:uranium_ore>);
