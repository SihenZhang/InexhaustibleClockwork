...
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock>, 400000, [<Creator:chamberOsmium>, <Mekanism:ControlCircuit:3> * 4, <minecraft:piston> * 2, <Creator:motorACTPA> *2]);

#Osmium Compressor
recipes.remove(<Mekanism:MachineBlock:1>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:1>, 400000, [<Creator:chamberOsmium>, <Railcraft:anvil> * 2, <Mekanism:ControlCircuit:3> * 4, <Creator:motorACTPA> *2]);

#Combiner
recipes.remove(<Mekanism:MachineBlock:2>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:2>, 400000, [<Mekanism:MachineBlock:1>, <ExtraUtilities:cobblestone_compressed:1> * 2, <Mekanism:ControlCircuit:3> * 2, <Creator:denseOsmiumPlate> * 4]);

#Crusher
recipes.remove(<Mekanism:MachineBlock:3>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:3>, 400000, [<Creator:chamberOsmiumG>, <Creator:motorACTPA> * 2, <Mekanism:ControlCircuit:3> * 4, <Creator:compactOsmiumPlate>*2]);

#Metallurgic Infuser
recipes.remove(<Mekanism:MachineBlock:8>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:8>, 400000, [<Creator:chamberOsmium>, <Mekanism:ControlCircuit:3> * 4, <ImmersiveEngineering:graphiteElectrode>*2, <Creator:denseOsmiumPlate> * 4]);

#Purification Chamber
recipes.remove(<Mekanism:MachineBlock:9>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:9>, 400000, [<Creator:chamberOsmium>, <Mekanism:ControlCircuit:3> * 4,<Mekanism:GasTank> , <Creator:denseOsmiumPlate> * 4]);

#Energized Smelter
recipes.remove(<Mekanism:MachineBlock:10>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:10>, 400000, [<Creator:chamberOsmiumEH>, <Mekanism:ControlCircuit:3> * 4]);

#Teleporter
recipes.remove(<Mekanism:MachineBlock:11>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock:11>, 400000, [<Creator:chamberOsmium>*2, <Mekanism:ControlCircuit:3> * 8, <Mekanism:TeleportationCore>, <Creator:denseOsmiumPlate>*4]);
...
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>,<Mekanism:GasTank>,<Magneticraft:mg_tank>,<ThermalExpansion:Glass>*4]);
...
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:2>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>,<Mekanism:GasTank>*2,<Mekanism:EnrichedAlloy>*4, <ImmersiveEngineering:graphiteElectrode>*2]);

#Chemical Injection Chamber
recipes.remove(<Mekanism:MachineBlock2:3>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:3>, 500000, [<Mekanism:MachineBlock:9>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *2, <Mekanism:EnergyTablet>,<Mekanism:ReinforcedAlloy>*4]);

#Electrolytic Separator
recipes.remove(<Mekanism:MachineBlock2:4>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:4>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>,<Mekanism:ReinforcedAlloy>*4, <ImmersiveEngineering:graphiteElectrode>*2, <Mekanism:GasTank>*2,<Mekanism:ElectrolyticCore>]);
...
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:6>, 500000, [<Creator:chamberOsmiumG>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>, <Mekanism:GasTank>*2]);

#Chemical Washer
recipes.remove(<Mekanism:MachineBlock2:7>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:7>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>, <Mekanism:GasTank>, <Magneticraft:mg_tank>, <Creator:motorACTPA>]);

#Chemical Crystallizer
recipes.remove(<Mekanism:MachineBlock2:8>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:8>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>, <Mekanism:GasTank>*2, <ImmersiveEngineering:metalDecoration:4>*4]);

#Seismic Vibrator
recipes.remove(<Mekanism:MachineBlock2:9>);
mods.buildcraft.AssemblyTable.addRecipe(<Mekanism:MachineBlock2:9>, 500000, [<Creator:chamberOsmium>,<Creator:denseOsmiumPlate>*4, <Mekanism:ControlCircuit:3> *4, <Mekanism:EnergyTablet>, <Railcraft:anvil>, <Creator:motorACTPA>*2, <ImmersiveEngineering:coil:4>*4]);
